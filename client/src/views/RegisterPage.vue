  ...
  <div class="center-content border-radius-task">
      ...
      <div>
          <form class="shadow-md rounded px-8 pt-6 pb-8 mb-4 regBox" v-on:submit.prevent="registerNewUser" >
              <div class="text-2xl mb-8 font-bold text-gray-700">Register</div>
              <div class="mb-4">
                  ...
                  <input
                      ...
                      id="username" v-model="userNameRegister" type="text" placeholder="John Doe">
              </div>
              <div class="mb-4">
                  ...
                  <input
                      class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline"
                      id="usernameReg" v-model="emailRegister" type="email" placeholder="johndoe@mail.com">
              </div>
              <div class="mb-6">
                  ...
                  <input
                      ...
                      id="password" v-model="passwordRegister" type="password" placeholder="Password">
              </div>
